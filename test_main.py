...
class MyTestCase(unittest.TestCase):
    ...
    def test_blank(self):
        self.assertEqual({1, 2}, set_calc('(1 -2)'))
        self.assertEqual({1, 2, 3}, set_calc('(1- 3 ) '))
    ...
    def test_operator(self):
        ...
        self.assertEqual({1, 2, 5, 6, 7}, set_calc('(1-2) or (5-7)'))

    def test_operator_all(self):
        self.assertEqual({3, 4, 5, 6}, set_calc('(1-6) and (3-9)'))
        self.assertEqual({1, 2, 3, 4, 5, 6, 7, 8, 9}, set_calc('(1-6) or (3-9)'))
        self.assertEqual({1, 2, 7, 8, 9}, set_calc('(1-6) xor (3-9)'))
